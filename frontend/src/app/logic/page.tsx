...
export const LogicPage = () => {
  ...
  return (
		<div className='flex flex-col items-center justify-center'>
		  ...
		  {walletClient && (
			<>
			  <h2>1. Your ENS Name: {ensName || "Loading..."}</h2>
			  
			  {/* STEP 2 */}
			  {ensName && (
				<>
				  {dankAddress ? (
					<h2>2. Your Resolved Dank Chat Address: {dankAddress}</h2>
				  ) : (
					<button onClick={onSetDankAddress}>
					  2. Generate Dank Account & Set Address
					</button>
				  )}
